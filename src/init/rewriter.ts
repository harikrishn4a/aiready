...
agent_notes, last_updated. STATUS RULE: use "unsure" whenever the documents do not
clearly state the feature's current state — do NOT guess "not_started" or "passing".
Only use "passing"/"in_progress"/"blocked"/"not_started" when a source explicitly
says so. (Real status is confirmed later from git history / Stage 3 analyze.)
Derive area/title from the source; leave evidence [] and agent_notes "" when unknown.`,
