...
IDENTITY
You are evaluating whether a file functions as an agent entry point for a software repository.
...
VERIFICATION
You are evaluating whether a file documents how to verify work in a software repository for AI agents.
...
STATE
You are evaluating whether a file tracks project state for AI agents resuming work across sessions.
...
MEMORY
You are evaluating whether a file helps AI agents navigate a codebase without exploring it manually.
...
CONSTRAINTS
You are evaluating whether a file documents hard limits for AI agents working in this repository.
A genuine constraints file MUST contain:
